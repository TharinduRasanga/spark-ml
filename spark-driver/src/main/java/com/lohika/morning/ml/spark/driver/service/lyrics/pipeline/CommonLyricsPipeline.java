    ...
    public GenrePrediction predict(final String unknownLyrics) {
        ...
        if (Arrays.asList(predictionsDataset.columns()).contains("probability")) {
            ...
            return new GenrePrediction(getGenre(prediction).getName(),
                    probability.apply(1), // Pop probability
                    probability.apply(2), // Country probability
                    probability.apply(3), // Blues probability
                    probability.apply(4), // Jazz probability
                    probability.apply(5), // Reggae probability
                    probability.apply(6), // Rock probability
                    probability.apply(7)); // Hip hop probability
        }
